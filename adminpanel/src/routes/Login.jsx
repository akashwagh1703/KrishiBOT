...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      // TODO: const response = await axios.post('/api/v1/admin/login', credentials);
      ...
      <div className="w-full max-w-md">
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-400">Multi-Client Chatbot Management</p>
          </div>
          ...
          <div className="mt-6 text-center space-y-2">
            <p className="text-sm text-gray-600 dark:text-gray-400">Are you a client?</p>
            <button
